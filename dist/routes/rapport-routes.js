...
// Ventes par mois
router.get('/ventes-par-mois/:annee?', middleware_auth_1.authMiddleware, (req, res) => rapportController.getVentesParMois(req, res));
// Ventes par type de tarif
router.get('/ventes-par-tarif', middleware_auth_1.authMiddleware, (req, res) => rapportController.getVentesParTypeTarif(req, res));
